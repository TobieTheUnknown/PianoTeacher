...
export function LivePlayMobileOverlay({
  ...
  return (
    <div className={`${styles.overlay} ${visible ? styles.overlayVisible : styles.overlayHidden}`}>
      ...
      <button className={styles.tapCatcher} onClick={handleTap} aria-label="Afficher ou masquer les contrôles" />

      {/* Top HUD: back · centered title+composer · fullscreen */}
      <div className={styles.topHud}>
        <button className={styles.iconCircle} onClick={onBack} title="Retour" aria-label="Retour">
