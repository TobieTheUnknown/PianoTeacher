...
- `npm --prefix web test` : **58 tests réussis**, aucun échec. Musique, motifs, gravure pure, voix et silences, MIDI aller-retour, migration et protection des sauvegardes, cycle audio simulé, cohérence MIDI navigateur/Tauri, cycle de connexion MIDI, découpe en 6/8, projection des tenues et reprise audio après seek.
